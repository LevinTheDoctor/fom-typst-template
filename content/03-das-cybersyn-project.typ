...
#tabelle(
  table(
    ...
    [Damit sollte geprüft werden, ob eine Entscheidung sich positiv oder negativ auf die Wirtschaft auswirkt – so ließen sich Ideen auch ohne Rechner leicht testen.],
  ),
