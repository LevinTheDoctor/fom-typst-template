...
Die Entwicklung des Cybersyn-Projekts war der Versuch, Allendes Politik mithilfe der Management-Kybernetik in einem technischen System abzubilden.#vgl(<espejoCybersynBigData2022>, seite: 1163)
#abbildung(
  align(center, image("../abbildungen/zeitstarhl.png", width: 90%)),
  titel: [Verlauf des Cybersyn-Projekts],
  quelle: [Eigene Darstellung in Anlehnung an #zitat(<medinaCyberneticRevolutinaries2014>) und #zitat(<espejoCybersynBigData2022>, seite: 1166), angepasst durch Claude Opus 5 am 27.08.2026],
)<abb-zeitstarhl>
== Allendes Politik
Allende war Sozialist mit dem Ziel, die Schlüsselindustrien zu verstaatlichen,#vgl(<bildung1970SalvadorAllende2015>) Chile durch Reformen in einen sozialistischen Staat umzuwandeln und alle demokratischen Institutionen zu erhalten. Dieser Ansatz wurde als „chilenischer Weg zum Sozialismus“ bekannt. Die USA sowie die Opposition Allendes waren mit seinem Kurs nicht zufrieden.#footnote[Allende gewann die Wahl mit nur 1,3 % Vorsprung gegenüber
  dem ehemaligen Präsidenten Chiles Jorge Alessandri. Vgl. #zitat-kap(<medinaCyberneticRevolutinaries2014>, kap: "2 Cybernetics in the Battle for Production").] Dies führte zu den Streiks gegen die Regierung sowie dem späteren Militärputsch und dem Ende Cybersyns durch den Regierungswechsel (@abb-zeitstarhl).#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "2 Cybernetics in the Battle for Production")
\ Durch die Verstaatlichung stand die #abk("CORFO") – die chilenische Staatsentwicklungsbehörde – vor der Aufgabe, die Unternehmen samt ihren Mitarbeiter*innen zu steuern.#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "1 Cybernetics and Socialism")
#abbildung(
  ...
  quelle: [Eigene Darstellung in Anlehnung an #zitat-kap(<medinaCyberneticRevolutinaries2014>, kap: "2 Cybernetics in the Battle for Production"), angepasst durch Claude Opus 5 am 27.08.2026],
)<abb-hCvCnsy>
...
Beer hatte das #abk("VSM") bereits vor seinem ersten Besuch entwickelt und gab den Mitarbeiter*innen am Projekt die Manuskripte für #emph()[Brain of the Firm].#vgl(<brain-of-the-firm>, seite: 248)
#abbildung(
  ...
  quelle: [Eigene Darstellung in Anlehnung an Auszüge aus Beers Bericht #emph()[Cybernetic Notes on the Effective Organisation of the State with Particular Reference to Industrial Control] #zitat(<brain-of-the-firm>, seite: 249), angepasst durch Claude Opus 5 am 27.08.2026],
...
Bei seinem ersten Entwurf plante Beer Cyberstride, CHECO und Cybernet.#footnote[Beer hat bei dem Projekt einen Großteil der Planung der Komponenten Cybersyns übernommen sowie die theoretische Grundlage mit dem #abk("VSM") geliefert. Allerdings sollte ihm das Projekt nicht vollständig zugeschrieben werden, da die Implementierung der Komponenten von anderen übernommen wurde. Cyberstride wurde von der #abk("ECOM") und dem Londoner Büro der US-amerikanischen Unternehmensberatung Arthur Andersen übernommen. Vgl. #zitat-kap(<medinaCyberneticRevolutinaries2014>, kap: "3 Designing a Network"). CHECO wurde von Ron Anderton und Mario Grandi entwickelt. Vgl. #zitat-kap(<medinaCyberneticRevolutinaries2014>, kap: "3 Designing a Network"). Der Operationsraum wurde von #abk("INTEC") unter der Leitung von Gui Bonsiepe entworfen. Vgl. #zitat(<brain-of-the-firm>, seite: 268). Die operative Leitung übernahm Raúl Espejo. Vgl. #zitat(<espejoCybersynBigData2022>). Da der Fokus der Arbeit aber auf der Funktion und Theorie hinter dem Projekt liegt, findet dies später wenig Erwähnung.] Hinzu kam der Operationsraum.#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "3 Designing a Network") Dieser war als futuristische Vision#footnote[Der Operationsraum ist der bekannteste Teil des Cybersyn-Projekts, insbesondere wegen seines futuristischen Designs. Cybersyn wird deshalb oft als Science-Fiction dargestellt. Espejo entkräftet diese Sicht in #zitat(<espejoCybersynBigData2022>) und arbeitet das #abk("VSM") als die innovativste Komponente des Projekts heraus. Vgl. #zitat(<espejoCybersynBigData2022>, seite: 1165).] geplant, blieb aber wegen technischer Limitationen ein Prototyp.#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "4 Constructing the Liberty Machine")
#tabelle(
  table(
    columns: 2,
...
#abbildung(
  ...
  quelle: [Eigene Darstellung in Anlehnung an #zitat-kap(<medinaCyberneticRevolutinaries2014>, kap: "3 Designing a Network"), angepasst durch Claude Opus 5 am 27.08.2026],
)<abb-telex-aufbau>
...
#abbildung(
  ...
  quelle: [Eigene Darstellung in Anlehnung an #zitat(<brain-of-the-firm>, seite: 269) und Gebäudeplan aus #zitat-kap(<medinaCyberneticRevolutinaries2014>, kap: "4 Constructing the Liberty Machine"), angepasst durch Claude Opus 5 am 27.08.2026],
)<abb-opsroom>
...
#tabelle(
  table(
    ...
    [Panel of the Future],
    [Das #emph()[Panel of the Future] war eine in Stoff gehüllte Magnetwand mit unterschiedlichen Magneten, die jeweils einen Teil der Wirtschaft darstellten.#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "4 Constructing the Liberty Machine")],
...
@tab-opsroom-aufbau schlüsselt die Bestandteile des Operationsraums auf. Der Aufbau der Geräte (@tab-opsroom-aufbau) zeigt, dass der Raum ein Prototyp blieb. Ein Beispiel ist das Panel of the Future, das ursprünglich eine Simulation durch CHECO zeigen sollte – der dafür nötige Computer wurde jedoch nie fertiggestellt.#vgl(<brain-of-the-firm>, seite: 270)
\ Die Stühle waren um die Mitte des Raums so angeordnet, dass von jedem aus alles zu sehen war. Das Bedienfeld war explizit auf Arbeiter*innen zugeschnitten; die Steuerung sollte leicht bedienbar sein. Beer nannte sie #emph()[Big Hand Control].#vgl(<brain-of-the-firm>, seite: 270)
