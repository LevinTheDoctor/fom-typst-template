...
Bei der Präsidentschaftswahl am 4. September 1970 in Chile gewann die #abk("UP") mit dem Kandidaten #emph()[Salvador Allende]#vgl(<bildung1970SalvadorAllende2015>). Allende war ein Sozialist mit dem Ziel, die Industrie im Besitz von multinationalen Konzernen sowie der chilenischen Oligarchie zu verstaatlichen #vgl(<bildung1970SalvadorAllende2015>) und Chile durch Reformen zu einem sozialistischen Staat zu formen und alle demokratischen Institutionen aufrechtzuerhalten. Durch den Erhalt
demokratischer Institutionen bei gleichzeitiger
Verstaatlichung wurde Allendes Ansatz bekannt als „chilenischer Weg zum Sozialismus“. #vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "2 Cybernetics in the Battle for Production")
\ In einer Rede vor den Vereinten Nationen erwähnte Allende, dass in den letzten 42 Jahren Konzerne aus den #abk("USA") mit einem Investment von 30 Millionen US-Dollar in der chilenischen Kupferindustrie Einnahmen von vier Milliarden US-Dollar generieren konnten, während Teile der chilenischen Bevölkerung sich nicht ausreichend ernähren konnten. #vgl(<SalvadorAllendeSpeech>) Die US-Regierung wollte den sozialistischen Weg der Allende-Regierung durch eine verdeckte Operation verhindern. Bei der verdeckten Operation finanzierten sie Oppositionsparteien und Medien.#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "2 Cybernetics in the Battle for Production")
\  Nachdem Allendes Regierung die Industrie verstaatlicht hatte, stand sie vor dem Problem, die Unternehmen samt ihrer Mitarbeiter*innen zu steuern. Um diese Probleme zu lösen, kam #emph()[Fernando Flores], der während Allendes Regierung technischer Generaldirektor der #abk("CORFO") – der chilenischen Staatsentwicklungsbehörde #vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "1 Cybernetics and Socialism") – war, auf die Idee, den britischen Kybernetiker #emph()[Stafford Beer] zu kontaktieren. Flores hatte während seines Studiums #emph()[Cybernetics and Management] von Beer gelesen und hoffte, die Steuerung der Wirtschaft Chiles durch Management-Kybernetik erleichtern zu können. #vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "1 Cybernetics and Socialism")
#abbildung(
...
Das Problem dabei war, dass die Komitees und auch die Interventoren keine klaren Rollen hatten.  Zusätzlich gab es in manchen Sektoren zu wenig qualifizierte Interventoren. #vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "2 Cybernetics in the Battle for Production")
\ Als Beer den Brief von Flores erhielt, war er als Berater tätig. Für Beer war die Einladung unwiderstehlich, da er so seine Ideen auf nationaler Ebene testen konnte. #vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "1 Cybernetics and Socialism") Beer ließ seine Beraterverträge auslaufen und kam vier Monate nach der Einladung von Flores nach Chile, um seine Arbeit an dem Projekt zu beginnen.
...
Beer erstellte während seines Besuchs im November 1971 zwei Berichte, der erste Bericht beschäftigte sich damit, wie der chilenische Staat in dem #abk("VSM") abgebildet werden könnte, zu sehen in @abb-beer-chile-mappin.
...
In @abb-telex-aufbau ist aufgezeigt, wie die Kommunikation über Cybernet abgelaufen ist. Die Interventoren innerhalb einer Firma hatten ein Telexgerät, mit dem sie ihre Daten an die #abk("ECOM") übertrugen. Dort wurden die Daten in den Mainframe eingespeist. Auf diesem wurden durch das Cyberstride-Programm statistische Berechnungen durchgeführt. Eine Besonderheit in @abb-telex-aufbau ist die Benachrichtigung der #abk("CORFO") bei Ausnahmen. Dies ist die Funktion von Cyberstride aus @tab-komp-swp, welche ebenfalls durch Cybernet abgeleitet wird. Durch die statistischen Berichte war es schwer für Interventoren, Produktionsdaten zu fälschen. #vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "3 Designing a Network")
\ Nachdem die drei gerade erklärten Komponenten funktionsfähig waren, kam der Operationsraum dazu. Der Operationsraum hatte das Ziel, die bestehenden Elemente miteinander zu verbinden. Aus dem Operationsraum sollten Entscheidungen basierend auf Live-Daten aus den anderen Komponenten getroffen werden.#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "3 Designing a Network")
#abbildung(
...
Das Design des Operationsraums kam vom #abk("INTEC") unter der Leitung von #emph()[Gui Bonsiepe].#vgl(<brain-of-the-firm>, seite: 268) In @abb-opsroom ist das Design des Raums aufgezeigt.
#tabelle(
  table(
    columns: 3,
...
In der @tab-opsroom-aufbau werden die Bestandteile des Operationsraums noch einmal genauer aufgeschlüsselt. Anhand des Aufbaus der Geräte in @tab-opsroom-aufbau sieht man, dass viele der Geräte nicht wirklich funktional waren. Der Raum wird oft als futuristische Vision bezeichnet, da der Raum wegen technischer Limitationen nie wirklich funktional umgesetzt wurde. #vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "4 Constructing the Liberty Machine") Ein Beispiel ist das #emph()[Panel of The Future] welches ursprünglich eine Live-Simulation durch CHECO sein sollte, der benötigte Computer wurde allerdings nie fertiggestellt.#vgl(<brain-of-the-firm>, seite: 270)
\ Um die Mitte des Raums waren sieben Stühle in einem Kreis angeordnet. Die Zahl der Stühle war absichtlich ungerade, damit bei Abstimmungen kein Gleichstand möglich war.#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "4 Constructing the Liberty Machine") Die Stühle wurden extra so angeordnet, sodass aus jedem Stuhl alles gesehen werden konnte. Das Bedienfeld des Operationsraums war explizit auf Arbeiter*innen zugeschnitten. Die Steuerung sollte leicht bedienbar sein. Beer nannte es auch #emph()[Big Hand Control], da die Knöpfe zusätzlich sehr robust waren. #vgl(<brain-of-the-firm>, seite: 270)
