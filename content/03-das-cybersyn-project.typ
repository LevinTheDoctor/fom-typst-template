...
Die Entwicklung des Cybersyn-Projekts war der Versuch, Allendes Politik mithilfe des #abk("VSM") und der Management-Kybernetik in einem technischen System abzubilden.#vgl(<espejoCybersynBigData2022>, seite: 1) Beides wird in diesem Kapitel erörtert.
#abbildung(
...
Die #abk("CORFO") unterteilte die Wirtschaft in vier Zweige mit untergeordneten Sektoren (@abb-hCvCnsy). #emph()[Interventoren] ersetzten die bisherigen Eigentümer und Manager und überwachten die Unternehmen der Sektoren. Die Sektoren selbst wurden jeweils von einem Komitee beaufsichtigt.#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "2 Cybernetics in the Battle for Production")
== Entstehung Cybersyns
Weder Komitees noch Interventoren hatten klare Rollen. Zudem gab es zu wenige qualifizierte Interventoren für bestimmte Sektoren.#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "2 Cybernetics in the Battle for Production") Deshalb kam #emph()[Fernando Flores] – technischer Generaldirektor der #abk("CORFO") – auf die Idee, #emph()[Stafford Beer] zu kontaktieren, um die Steuerung der chilenischen Wirtschaft durch Management-Kybernetik zu erleichtern.#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "1 Cybernetics and Socialism") Beer nahm die Einladung an, da er so seine Ideen auf nationaler Ebene testen konnte.#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "1 Cybernetics and Socialism")
...
#tabelle(
  table(
    ...
    [CHECO],
    [CHECO – ein Akronym für CHilean ECOnomy – war eine Simulation der chilenischen Wirtschaft, die der Regierung als Labor zur Prognose von Entscheidungsauswirkungen dienen sollte. Für Beer war es eine Implementierung des Systems 4.#vgl(<brain-of-the-firm>, seite: 266)],

    [Cybernet],
    [Cybernet war ein Netzwerk, das die verschiedenen Unternehmen verbinden sollte, und bildete das Rückgrat des Projekts: Es sendete die Live-Daten an die Programme und ermöglichte die Kommunikation auf unterschiedlichen Ebenen.],
...
\ Für die CHECO lehnte Beer die Input-Output-Analyse ab, da er sie als strukturarm empfand und stochastische Elemente darin kaum einführbar waren.#vgl(<brain-of-the-firm>, seite: 265) Zudem hätten dafür zunächst große Datenmengen gesammelt werden müssen, was die Projektfrist nicht zuließ. Beer nutzte deshalb die Sprache DYNAMO.#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "3 Designing a Network")
...
@abb-telex-aufbau zeigt den Ablauf der Kommunikation über Cybernet, darunter die Benachrichtigung der #abk("CORFO") bei Ausnahmen – eine Funktion von Cyberstride (@tab-komp), die über Cybernet implementiert wurde. Die statistischen Berichte erschwerten es Interventoren, Produktionsdaten zu fälschen.#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "3 Designing a Network")
#abbildung(
...
@tab-opsroom-aufbau schlüsselt die Bestandteile des Operationsraums auf. Durch Aufbau der Geräte aus @tab-opsroom-aufbau zeigt sich, dass viele davon kaum funktional waren. Ein Beispiel ist das #emph()[Panel of The Future], das ursprünglich eine Live-Simulation durch CHECO zeigen sollte – der dafür nötige Computer wurde jedoch nie fertiggestellt.#vgl(<brain-of-the-firm>, seite: 270)
