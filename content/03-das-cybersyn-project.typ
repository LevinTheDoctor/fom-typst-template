...
#abbildung(
  ...
  quelle: [Eigene Darstellung in Anlehnung an #zitat(<medinaCyberneticRevolutinaries2014>) und #zitat(<espejoCybersynBigData2022>, seite: 1166), angepasst durch Claude Opus 5.0 ],
)<abb-zeitstarhl>
== Allendes Politik
...
#abbildung(
  ...
  quelle: [Eigene Darstellung in Anlehnung an #zitat-kap(<medinaCyberneticRevolutinaries2014>, kap: "2 Cybernetics in the Battle for Production"), angepasst durch Claude Opus 5.0 ],
)<abb-hCvCnsy>
Die #abk("CORFO") unterteilte die Wirtschaft in vier Zweige mit untergeordneten Sektoren (@abb-hCvCnsy). #emph()[Interventoren] ersetzten die bisherigen Eigentümer und Manager und überwachten die Unternehmen der Sektoren.#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "2 Cybernetics in the Battle for Production") Weder Komitees noch Interventoren hatten klare Rollen. Zudem gab es zu wenige qualifizierte Interventoren für bestimmte Sektoren.#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "2 Cybernetics in the Battle for Production") Deshalb kam #emph()[Fernando Flores] #footnote[Flores war 1971 der technischer Generaldirektor der CORFO mit 29 Jahren Vgl. #zitat-kap(<medinaCyberneticRevolutinaries2014>, kap: "1 Cybernetics and Socialism")] auf die Idee, #emph()[Stafford Beer] zu kontaktieren #footnote[Flores hatte Während seine Studiums Beers Buch #emph()[Cybernetics and Management] gelesen. Vgl. #zitat-kap(<medinaCyberneticRevolutinaries2014>, kap: "2 Cybernetics in the Battle for Production")], um die Steuerung der chilenischen Wirtschaft durch Management-Kybernetik zu erleichtern.#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "1 Cybernetics and Socialism") Beer nahm die Einladung an, da er so seine Ideen auf nationaler Ebene testen konnte.#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "1 Cybernetics and Socialism")
...
#abbildung(
  ...
  quelle: [Eigene Darstellung in Anlehnung an Auszüge aus Beers Bericht #emph()[Cybernetic Notes on the Effective Organisation of the State with Particular Reference to Industrial Control] #zitat(<brain-of-the-firm>, seite: 249), angepasst durch Claude Opus 5.0 ],
...
Bei seinem ersten Entwurf plante Beer die Komponenten Cyberstride, CHECO und Cybernet.#footnote[Beer hat bei dem Projekt einen Großteil der Planung der Komponenten Cybersyns übernommen, sowie die theoretische Grundlage mit dem #abk("VSM") geliefert. Allerdings sollte ihm das Projekt nicht vollständig zugeschrieben werden, da die Implementierung der Komponenten von anderen übernommen wurde. Cyberstride wurde von der #abk("ECOM") und dem Londoner Büro der US-amerikanischen Unternehmensberatung Arthur Andersen übernommen. Vgl. #zitat-kap(<medinaCyberneticRevolutinaries2014>, kap: "3 Designing a Network"). CHECO wurde von Ron Anderton und Mario Grandi entwickelt. Vgl. #zitat-kap(<medinaCyberneticRevolutinaries2014>, kap: "3 Designing a Network"). Der Operationsraum wurde von #abk("INTEC") unter der Leitung von #emph[Gui Bonsiepe] entworfen. Vgl. #zitat(<brain-of-the-firm>, seite: 268). Die operative Leitung übernahm Raúl Espejo. Vgl. #zitat(<espejoCybersynBigData2022>). Da der Fokus der Arbeit aber auf die Funktion und Theorie hinter dem Projekt eingeht, findet es später wenig Erwähnung.] Hinzu kam der Operationsraum.#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "3 Designing a Network") Dieser war als futuristische Vision #footnote[Der Operationsraum ist das Ikonischte an dem Cybersyn Projekt – insbesondere wegen seinem futuristischen design – Allerdings wird Cybersyn deshalb oft als Science Fiktion Dargestellt. Espjeo entkräfte diese in #zitat(<espejoCybersynBigData2022>) und Arbeitet das #abk("VSM") als die inovaiste Komponente des Projektes raus. Vgl. #zitat(<espejoCybersynBigData2022>, seite: 1165) ] geplant, blieb aber wegen technischer Limitationen ein Prototyp.#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "4 Constructing the Liberty Machine")
#tabelle(
  table(
    columns: 2,
...
#abbildung(
  ...
  quelle: [Eigene Darstellung in Anlehnung an #zitat-kap(<medinaCyberneticRevolutinaries2014>, kap: "3 Designing a Network"), angepasst durch Claude Opus 5.0 ],
)<abb-telex-aufbau>
...
#abbildung(
  ...
  quelle: [Eigene Darstellung in Anlehnung an #zitat(<brain-of-the-firm>, seite: 269) und Gebäudeplan aus #zitat-kap(<medinaCyberneticRevolutinaries2014>, kap: "4 Constructing the Liberty Machine"), angepasst durch Claude Opus 5.0 ],
)<abb-opsroom>
