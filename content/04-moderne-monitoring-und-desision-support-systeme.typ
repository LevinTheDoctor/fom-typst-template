...
Ein Monitoring-System ist je nach zu überwachendem Bereich unterschiedlich aufgebaut.
#tabelle(
  table(
    columns: 3,
...
Azure Monitor#footnote[In diesem Kapitel wird die Dokumentation des Azure Monitor von Microsoft Learn als Primärquelle genutzt; Azure Monitor ist nur ein Beispiel für Monitoring-System und #abk("DSS") als Observability-Dienst in der Cloud.] ist der #emph[Observability]-Dienst der Azure Cloud.#vgl(<austinmccollumAzureMonitorUebersicht>) In @abb-ms-dss-cloud und @tab-obsr-cloud wurde erklärt, wie Monitoring-System und #abk("DSS") in Cloud-Umgebungen zusammenarbeiten.
#abbildung(
