...
Das #abk("VSM") lässt sich auf Azure Monitor übertragen (@tab-am-vsm). Der Fokus Cybersyns auf Echtzeitdaten,#vgl(<espejoCybersynBigData2022>, seite: 1166) der wegen der technischen Limitationen nicht umgesetzt wurde,#vgl-kap(<medinaCyberneticRevolutinaries2014>, kap: "4 Constructing the Liberty Machine") ist auch bei dem Azure Monitor wieder zu finden.#vgl(<austinmccollumAzureMonitorUebersicht>) Der #abk("KPI") ist ein Faktor, den Azure Monitor besitzt, Cybersyn aber erst durch Weiterarbeit bis zur Mitte der 1980er erhielt.#vgl(<espejoCybersynBigData2022>, seite: 1166) Azure Monitors #abk("KPI")s sind Anwendungs- und Infrastrukturmetriken.#vgl(<austinmccollumAzureMonitorUebersicht>)
