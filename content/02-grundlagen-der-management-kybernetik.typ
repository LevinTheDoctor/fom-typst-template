...
#abbildung(
  image("../abbildungen/VSM-Modell.png", width: 60%),
  titel: [Aufbau des Viable System Modell],
  quelle: "QUELLE ERGÄNZEN",
) <abb-vsm>
...
#table(
  ...
  [Umwelt],
  [Die Umwelt ist der Kontext, mit dem sich ein System auseinandersetzt. Die grau schraffierten Flächen sind Überschnitte aus mehreren Kontexten],

  [Operatives System],
  [Das operative System ist die ausführende Ebene mit einer klaren Aufgabe. Die operativen Systeme sind intern selber auch nach dem Viable System Modell aufgebaut, da das Viable System Modell rekursiv aufgebaut ist. Die operativen Systeme handeln meist autonom, aber informieren die Metasysteme und erhalten von ihnen Ziele],
